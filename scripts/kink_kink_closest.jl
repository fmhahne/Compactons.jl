...
fig, ax = plt.subplots()
ax.scatter(Vs, xRmins; color="black", marker="o", s=3, label="Simulation")
ax.scatter(Vs, xRmins_a; marker="+", s=3, label="Non-relativistic")
ax.scatter(Vs, xRmins_ab; marker="x", s=3, label="Relativistic")
ax.set_xlabel(raw"$v$")
